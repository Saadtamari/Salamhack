// Mock data for Masraf prototype
...
window.MASRAF_DATA = {
  ...
  invoices: [
    ...
    { id: "INV-2026-023", client: "شركة رياح", client: "شركة رياح", clientEn: "Riyah Corp", amount: 600, status: "overdue", due: "١٠ أبريل ٢٠٢٦", daysOverdue: 17 },
  ],
  ...
  cashflow: [
    ...
    { month: "مايو", income: 12200, expenses: 4100 }, // predicted
    { month: "يونيو", income: 13800, expenses: 4500 }, // predicted
  ],
